...
export default function Home() {
  ...
  return (
    <>
      ...
      <br />
      <Link href={"/movies"}>
        <h2 className="font-bold text-lg">Upcoming Movies</h2>
      </Link>
      ...
      <Link href={"/movies/topRated"}>
        <h2 className="font-bold text-lg">Top Rated Movies</h2>
      </Link>
      ...
      <Link href={"/movies/mostPopular"}>
        <h2 className="font-bold text-lg">Most Popular Movies</h2>
      </Link>
      ...
      <Link href={"/movies/nowPlaying"}>
        <h2 className="font-bold text-lg">Now Playing Movies</h2>
      </Link>
