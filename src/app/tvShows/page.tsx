...
export default function Page() {
  ...
  const [errorMostPopularTVShows, setErrorMostPopularTVShows] = useState(null);
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        ...
        setMostPopularTVShows(res.data.results);
        setLoadingMostPopularTVShows(false);
      })
      .catch((err) => {
        console.error(err);
        setLoadingMostPopularTVShows(false);
        setErrorMostPopularTVShows(err.message);
      });
  }, []);
