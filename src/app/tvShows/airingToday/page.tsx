...
export default function Page() {
  ...
  const [errorAiringTodayTVShows, setErrorAiringTodayTVShows] = useState(null);
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        ...
        setAiringTodayTVShows(res.data.results);
        setLoadingAiringTodayTVShows(false);
      })
      .catch((err) => {
        console.error(err);
        setLoadingAiringTodayTVShows(false);
        setErrorAiringTodayTVShows(err.message);
      });
  }, []);
